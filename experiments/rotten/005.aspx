        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <p>
                    ...
                    <a href="http://api.rottentomatoes.com/api/public/v1.0/movies.json?apikey=tzwrqjff57nqwdwa32fc5fkv&q=Avatar&page_limit=1" target="_blank">Click to get Avatar JSON response</a>
                </p>
                <pre>
    ...
    <script>
        ...
        function rottenTomatoesMovieSearch(movieTitle, callback) {
            ...
            $.ajax({
                ...
                dataType : "jsonp",
                data: { apikey: "tzwrqjff57nqwdwa32fc5fkv", q: movieTitle },
